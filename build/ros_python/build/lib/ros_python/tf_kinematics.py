...
class TFKinematic(Node):
    def __init__(self):
        ...
        #For consecutive location and rotation change
    ...
    def timerCallBack(self):
        ...
        self.static_transform_stamped_.transform.translation.x = self.x_increment_ + self.last_x_
        self.static_transform_stamped_.transform.translation.y = 0.0
        self.static_transform_stamped_.transform.translation.z = 0.3
        ...
        self.last_x_=self.static_transform_stamped_.transform.translation.x
    ...
    def getTransformCallback(self, req, res):
        ...
        try:
            ...
            self.get_logger().error("An error according while transforming %s and %s" % (req.frame_id, req.child_frame_id))
            res.success=False
            return res
