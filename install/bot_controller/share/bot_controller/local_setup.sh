...
: ${AMENT_CURRENT_PREFIX:="/home/mehmet/ros/install/bot_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bot_controller/environment/pythonpath.sh"
