...
class TurtlesimKinematics(Node):
    def __init__(self):
        ...
        self.turtle1_pose_sub_ = self.create_subscribtion(Pose, "/turtle1/pose", self.turtle1PoseCallback, 10)
        self.turtle2_pose_sub_ = self.create_subscribtion(Pose, "/turtle2/pose", self.turtle2PoseCallback, 10)
